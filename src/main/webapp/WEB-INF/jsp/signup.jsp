...
<body>
	<div class="card mt-5" style="width: 20rem; margin: auto;">
		<div class="card-body text-center">
			...
			<form class="mb-4" action="/process_signup" method="post"
				modelAttribute="user">
				...
				<div class="form-group mt-2 mb-5">
					<label for="password" class="visually-hidden">password</label> <input
				...
				<footer class="mt-5 text-muted">
					&copy; 2022. <a href="/">OneStopGroceries</a> portal.<br /> Made
					with <i class="fa-solid fa-heart"></i> in Penang.<br /> <i
						class="fa-brands fa-github"></i> <a
						href="https://github.com/hadrihl/onestopgroceries">
						onestopgroceries</a>
				</footer>
			</form>
		</div>
